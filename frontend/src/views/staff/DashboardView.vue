<template>
  <div>
    ...
    <div class="row mb-4">
      <div class="col-12">
        <div class="p-4 rounded-3 text-white" style="background: linear-gradient(135deg, #2d5a8e 0%, #4a90d9 100%); box-shadow: 0 4px 15px rgba(45, 90, 142, 0.15);">
          ...
          <p class="mb-0" style="opacity: 0.85; font-size: 0.9375rem;">
            You are logged in as <strong>Barangay Staff</strong>. Access and process assigned registry systems.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="row g-3">
      ...
      <!-- Quick Actions Sidebar (Staff version, no reports) -->
      <div class="col-lg-4">
        <div class="card border-0 shadow-sm">
          <div class="card-header bg-white py-3 border-0">
            <span class="fw-bold text-dark"><i class="bi bi-lightning-fill me-2 text-warning"></i>Operations Hub</span>
          </div>
          <div class="card-body p-0">
            <div class="list-group list-group-flush">
              <router-link :to="{ name: 'staff-residents' }" class="list-group-item list-group-item-action d-flex align-items-center gap-3 p-3 border-0 border-bottom border-light">
              ...
              <router-link :to="{ name: 'staff-documents' }" class="list-group-item list-group-item-action d-flex align-items-center gap-3 p-3 border-0 border-bottom border-light">
              ...
              <router-link :to="{ name: 'staff-blotters' }" class="list-group-item list-group-item-action d-flex align-items-center gap-3 p-3 border-0">
